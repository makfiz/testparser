export default function findMatchingIndustry(industry) {
  const Accom = [
    'Food',
    'Production',
    'Restaurants',
  ...
  const lists = {
    ...
    'Aerospace / Aviation': Aero,
    Agriculture: Agri,
    Automotive: Auto,
    'Biotech and Pharmaceuticals': Bio,
    'Commercial Services': Comm,
    'Computers and Technology': CaT,
    Construction: Const,
    ...
    'Industrial Machinery, Gas and Chemicals': Mach,
    Insurance: Ins,
    Legal: Legal,
    Manufacturing: Man,
    Media: Media,
    Mining: Min,
    'Non-Profit / Organizations': NonP,
    'Real Estate': RealE,
    Research: Res,
    'Retail and Consumer Goods': Retail,
    'Service Industry': Ser,
    Telecommunications: Tel,
    'Transportation and Logistics': Trans,
    'Travel / Hospitality / Entertainment': Trav,
    'Utility / Energy': Util,
  };
